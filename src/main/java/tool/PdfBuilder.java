...
public class PdfBuilder {
    ...
    public static final String INIT_PDF = PDF_BASE_PATH + System.currentTimeMillis() + ".pdf";
...
//        try (InputStream fontStream = this.getClass().getClassLoader().getResourceAsStream("font/SourceHanSansCN-VF.ttf")) {
...
//        this.document.close();
//        response.addHeader("Content-Disposition", "attacment;filename=agreement.pdf");
